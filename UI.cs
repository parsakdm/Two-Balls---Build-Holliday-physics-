...
public class UI : MonoBehaviour
{
	...
	public Text firstBallVelocityText;
	public Text secondBallVelocityText;
	...
	{
		firstBallVelocityText.text = "First ball velocity: " + firstBall.v0.x + " m/s";
		secondBallVelocityText.text = "Second ball velocity: " + secondBall.v0.x + " m/s";
